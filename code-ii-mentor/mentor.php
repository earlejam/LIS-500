...
<div class="row">
  <div class="col s12 m8 offset-m2">
    <h1>Become a <b><span style="color: #283593;">Mentor</span></b></h1>
  </div>
</div>
<div class="row">
    <form class="col s12 m8 offset-m2" action="mentor.php" method="post">
      <div class="row">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="skills">What subjects would you like to provide mentoring for? (Separate with commas, please)</label>
        </div>
      </div>
      <div class="row">
